...
public class CCTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CC_TAB_BLOCKS = CREATIVE_MODE_TABS.register("cc_tab_blocks", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(CCBlocks.RAINBOW_BISMUTH.get());
                ...
                output.accept(CCBlocks.RAINBOW_BISMUTH_BRICK_STAIRS.get());
                output.accept(CCBlocks.RAINBOW_BISMUTH_BRICK_SLAB.get());
                output.accept(CCBlocks.RAINBOW_BISMUTH_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.CYAN_BISMUTH_BRICK_STAIRS.get());
                output.accept(CCBlocks.CYAN_BISMUTH_BRICK_SLAB.get());
                output.accept(CCBlocks.CYAN_BISMUTH_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.VIOLET_BISMUTH_BRICK_STAIRS.get());
                output.accept(CCBlocks.VIOLET_BISMUTH_BRICK_SLAB.get());
                output.accept(CCBlocks.VIOLET_BISMUTH_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.PURPLE_BISMUTH_BRICK_STAIRS.get());
                output.accept(CCBlocks.PURPLE_BISMUTH_BRICK_SLAB.get());
                output.accept(CCBlocks.PURPLE_BISMUTH_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.YELLOW_BISMUTH_BRICK_STAIRS.get());
                output.accept(CCBlocks.YELLOW_BISMUTH_BRICK_SLAB.get());
                output.accept(CCBlocks.YELLOW_BISMUTH_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.CRUSTONE_BRICK_STAIRS.get());
                output.accept(CCBlocks.CRUSTONE_BRICK_SLAB.get());
                output.accept(CCBlocks.CRUSTONE_BRICK_WALL.get());
                output.accept(CCBlocks.CRACKED_CRUSTONE_BRICKS.get());
                output.accept(CCBlocks.CRACKED_CRUSTONE_BRICK_STAIRS.get());
                output.accept(CCBlocks.CRACKED_CRUSTONE_BRICK_SLAB.get());
                output.accept(CCBlocks.CRACKED_CRUSTONE_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.HOLY_MARBLE_BRICK_STAIRS.get());
                output.accept(CCBlocks.HOLY_MARBLE_BRICK_SLAB.get());
                output.accept(CCBlocks.HOLY_MARBLE_BRICK_WALL.get());
                output.accept(CCBlocks.CRACKED_HOLY_MARBLE_BRICKS .get());
                output.accept(CCBlocks.CRACKED_HOLY_MARBLE_BRICK_STAIRS.get());
                output.accept(CCBlocks.CRACKED_HOLY_MARBLE_BRICK_SLAB.get());
                output.accept(CCBlocks.CRACKED_HOLY_MARBLE_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.PUMICE_BRICK_STAIRS.get());
                output.accept(CCBlocks.PUMICE_BRICK_SLAB.get());
                output.accept(CCBlocks.PUMICE_BRICK_WALL.get());
                output.accept(CCBlocks.CRACKED_PUMICE_BRICKS.get());
                output.accept(CCBlocks.CRACKED_PUMICE_BRICK_STAIRS.get());
                output.accept(CCBlocks.CRACKED_PUMICE_BRICK_SLAB.get());
                output.accept(CCBlocks.CRACKED_PUMICE_BRICK_WALL.get());
                ...
                output.accept(CCBlocks.VERMILION_SALT_DEPOSIT.get());
                output.accept(CCBlocks.RED_SALT_DEPOSIT.get());
                output.accept(CCBlocks.ORANGE_SALT_DEPOSIT.get());
                output.accept(CCBlocks.YELLOW_SALT_DEPOSIT.get());
                output.accept(CCBlocks.GREEN_SALT_DEPOSIT.get());
                output.accept(CCBlocks.VERMILION_BRINE_VENT_BASE.get());
                output.accept(CCBlocks.VERMILION_BRINE_VENT_TOP.get());
                output.accept(CCBlocks.YELLOW_BRINE_VENT_BASE.get());
                output.accept(CCBlocks.YELLOW_BRINE_VENT_TOP.get());
                output.accept(CCBlocks.SALT_FORMATION.get());
                output.accept(CCBlocks.TALL_SALT_FORMATION.get());
                ...
                output.accept(CCBlocks.THUNDERSTONE_BRICK_STAIRS.get());
                output.accept(CCBlocks.THUNDERSTONE_BRICK_SLAB.get());
                output.accept(CCBlocks.THUNDERSTONE_BRICK_WALL.get());
