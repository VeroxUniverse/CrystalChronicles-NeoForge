...
public class LightningStaffItem extends AnimatedStaffItem implements IPresetSpellContainer {

    public final LightningStaffItemDispatcher dispatcher;

    List<SpellData> spellData = null;
    SpellDataRegistryHolder[] spellDataRegistryHolders;

    public LightningStaffItem(Properties pProperties, SpellDataRegistryHolder[] spellDataRegistryHolders) {
        super(pProperties);
        this.spellDataRegistryHolders = spellDataRegistryHolders;
        this.dispatcher = new LightningStaffItemDispatcher();
    }
