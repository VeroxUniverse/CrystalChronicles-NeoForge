package net.veroxuniverse.crystal_chronicles.item.weapon.holy;
...
public class HolySwordItem extends AnimatedSwordItemWithoutCasting implements IPresetSpellContainer {

    List<SpellData> spellData = null;
    SpellDataRegistryHolder[] spellDataRegistryHolders;

    public HolySwordItem(Tier pTier, Properties pProperties, SpellDataRegistryHolder[] spellDataRegistryHolders) {
