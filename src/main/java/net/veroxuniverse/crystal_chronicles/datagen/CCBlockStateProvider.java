...
public class CCBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        generateStoneFamily(CCBlocks.THUNDERSTONE_BRICKS, CCBlocks.THUNDERSTONE_BRICK_STAIRS, CCBlocks.THUNDERSTONE_BRICK_SLAB, CCBlocks.THUNDERSTONE_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.BISMITE_BRICKS, CCBlocks.BISMITE_BRICK_STAIRS, CCBlocks.BISMITE_BRICK_SLAB, CCBlocks.BISMITE_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.CRACKED_BISMITE_BRICKS, CCBlocks.CRACKED_BISMITE_BRICK_STAIRS, CCBlocks.CRACKED_BISMITE_BRICK_SLAB, CCBlocks.CRACKED_BISMITE_BRICK_WALL);
        ...
        // Bismuth Bricks
        generateBismuthBrickFamily(CCBlocks.CYAN_BISMUTH_BRICKS, CCBlocks.CYAN_BISMUTH_BRICK_STAIRS, CCBlocks.CYAN_BISMUTH_BRICK_SLAB, CCBlocks.CYAN_BISMUTH_BRICK_WALL);
        generateBismuthBrickFamily(CCBlocks.PURPLE_BISMUTH_BRICKS, CCBlocks.PURPLE_BISMUTH_BRICK_STAIRS, CCBlocks.PURPLE_BISMUTH_BRICK_SLAB, CCBlocks.PURPLE_BISMUTH_BRICK_WALL);
        generateBismuthBrickFamily(CCBlocks.RAINBOW_BISMUTH_BRICKS, CCBlocks.RAINBOW_BISMUTH_BRICK_STAIRS, CCBlocks.RAINBOW_BISMUTH_BRICK_SLAB, CCBlocks.RAINBOW_BISMUTH_BRICK_WALL);
        generateBismuthBrickFamily(CCBlocks.VIOLET_BISMUTH_BRICKS, CCBlocks.VIOLET_BISMUTH_BRICK_STAIRS, CCBlocks.VIOLET_BISMUTH_BRICK_SLAB, CCBlocks.VIOLET_BISMUTH_BRICK_WALL);
        generateBismuthBrickFamily(CCBlocks.YELLOW_BISMUTH_BRICKS, CCBlocks.YELLOW_BISMUTH_BRICK_STAIRS, CCBlocks.YELLOW_BISMUTH_BRICK_SLAB, CCBlocks.YELLOW_BISMUTH_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.CRUSTONE_BRICKS, CCBlocks.CRUSTONE_BRICK_STAIRS, CCBlocks.CRUSTONE_BRICK_SLAB, CCBlocks.CRUSTONE_BRICK_WALL);
        generateStoneFamily(CCBlocks.CRACKED_CRUSTONE_BRICKS, CCBlocks.CRACKED_CRUSTONE_BRICK_STAIRS, CCBlocks.CRACKED_CRUSTONE_BRICK_SLAB, CCBlocks.CRACKED_CRUSTONE_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.HOLY_MARBLE_BRICKS, CCBlocks.HOLY_MARBLE_BRICK_STAIRS, CCBlocks.HOLY_MARBLE_BRICK_SLAB, CCBlocks.HOLY_MARBLE_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.CRACKED_HOLY_MARBLE_BRICKS , CCBlocks.CRACKED_HOLY_MARBLE_BRICK_STAIRS, CCBlocks.CRACKED_HOLY_MARBLE_BRICK_SLAB, CCBlocks.CRACKED_HOLY_MARBLE_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.PUMICE_BRICKS, CCBlocks.PUMICE_BRICK_STAIRS, CCBlocks.PUMICE_BRICK_SLAB, CCBlocks.PUMICE_BRICK_WALL);
        ...
        generateStoneFamily(CCBlocks.CRACKED_PUMICE_BRICKS, CCBlocks.CRACKED_PUMICE_BRICK_STAIRS, CCBlocks.CRACKED_PUMICE_BRICK_SLAB, CCBlocks.CRACKED_PUMICE_BRICK_WALL);
