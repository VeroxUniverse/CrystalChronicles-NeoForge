...
public class CCBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(CCBlocks.THUNDERSTONE_BRICK_STAIRS.get(), CCBlocks.THUNDERSTONE_BRICK_SLAB.get(), CCBlocks.THUNDERSTONE_BRICK_WALL.get())
                ...
                .add(CCBlocks.BISMITE_BRICK_STAIRS.get(), CCBlocks.BISMITE_BRICK_SLAB.get(), CCBlocks.BISMITE_BRICK_WALL.get())
                ...
                .add(CCBlocks.CYAN_BISMUTH_BRICK_STAIRS.get(), CCBlocks.CYAN_BISMUTH_BRICK_SLAB.get(), CCBlocks.CYAN_BISMUTH_BRICK_WALL.get())
                .add(CCBlocks.PURPLE_BISMUTH_BRICK_STAIRS.get(), CCBlocks.PURPLE_BISMUTH_BRICK_SLAB.get(), CCBlocks.PURPLE_BISMUTH_BRICK_WALL.get())
                .add(CCBlocks.YELLOW_BISMUTH_BRICK_STAIRS.get(), CCBlocks.YELLOW_BISMUTH_BRICK_SLAB.get(), CCBlocks.YELLOW_BISMUTH_BRICK_WALL.get())
                .add(CCBlocks.RAINBOW_BISMUTH_BRICK_STAIRS.get(), CCBlocks.RAINBOW_BISMUTH_BRICK_SLAB.get(), CCBlocks.RAINBOW_BISMUTH_BRICK_WALL.get())
                .add(CCBlocks.VIOLET_BISMUTH_BRICK_STAIRS.get(), CCBlocks.VIOLET_BISMUTH_BRICK_SLAB.get(), CCBlocks.VIOLET_BISMUTH_BRICK_WALL.get())
                ...
                .add(CCBlocks.CYAN_BISMUTH_STAIRS.get(), CCBlocks.CYAN_BISMUTH_SLAB.get(), CCBlocks.CYAN_BISMUTH_WALL.get())
                ...
                .add(CCBlocks.CRUSTONE_BRICK_STAIRS.get(), CCBlocks.CRUSTONE_BRICK_SLAB.get(), CCBlocks.CRUSTONE_BRICK_WALL.get())
                .add(CCBlocks.CRACKED_CRUSTONE_BRICK_STAIRS.get(), CCBlocks.CRACKED_CRUSTONE_BRICK_SLAB.get(), CCBlocks.CRACKED_CRUSTONE_BRICK_WALL.get())
                ...
                // Holy
                .add(CCBlocks.HOLY_MARBLE.get(), CCBlocks.CHISELED_HOLY_MARBLE.get(), CCBlocks.CRACKED_HOLY_MARBLE_BRICKS .get(), CCBlocks.POLISHED_HOLY_MARBLE.get(), CCBlocks.HOLY_MARBLE_BRICKS.get())
                ...
                .add(CCBlocks.HOLY_MARBLE_BRICK_STAIRS.get(), CCBlocks.HOLY_MARBLE_BRICK_SLAB.get(), CCBlocks.HOLY_MARBLE_BRICK_WALL.get())
                ...
                .add(CCBlocks.CRACKED_HOLY_MARBLE_BRICK_STAIRS.get(), CCBlocks.CRACKED_HOLY_MARBLE_BRICK_SLAB.get(), CCBlocks.CRACKED_HOLY_MARBLE_BRICK_WALL.get())
                ...
                // Fire / Volcanic
                .add(CCBlocks.VOLCANITE_BLOCK.get(), CCBlocks.PYRITE.get(), CCBlocks.PUMICE.get(), CCBlocks.PUMICE_BRICKS.get(), CCBlocks.CHISELED_PUMICE.get(), CCBlocks.CRACKED_PUMICE_BRICKS.get(), CCBlocks.POLISHED_PUMICE.get())
                ...
                .add(CCBlocks.PUMICE_BRICK_STAIRS.get(), CCBlocks.PUMICE_BRICK_SLAB.get(), CCBlocks.PUMICE_BRICK_WALL.get())
                .add(CCBlocks.CHISELED_PUMICE_STAIRS.get(), CCBlocks.CHISELED_PUMICE_SLAB.get(), CCBlocks.CHISELED_PUMICE_WALL.get())
                .add(CCBlocks.CRACKED_PUMICE_BRICK_STAIRS.get(), CCBlocks.CRACKED_PUMICE_BRICK_SLAB.get(), CCBlocks.CRACKED_PUMICE_BRICK_WALL.get())
        ...
        this.tag(BlockTags.WALLS)
                .add(CCBlocks.THUNDERSTONE_WALL.get(), CCBlocks.CHISELED_THUNDERSTONE_WALL.get(), CCBlocks.THUNDERSTONE_BRICK_WALL.get(), CCBlocks.POLISHED_THUNDERSTONE_WALL.get())
                .add(CCBlocks.BISMITE_WALL.get(), CCBlocks.CHISELED_BISMITE_WALL.get(), CCBlocks.CRACKED_BISMITE_BRICK_WALL.get(), CCBlocks.POLISHED_BISMITE_WALL.get(), CCBlocks.BISMITE_BRICK_WALL.get())
                .add(CCBlocks.CYAN_BISMUTH_WALL.get(), CCBlocks.PURPLE_BISMUTH_WALL.get(), CCBlocks.VIOLET_BISMUTH_WALL.get(), CCBlocks.YELLOW_BISMUTH_WALL.get(), CCBlocks.RAINBOW_BISMUTH_WALL.get())
                .add(CCBlocks.CYAN_BISMUTH_BRICK_WALL.get(), CCBlocks.PURPLE_BISMUTH_BRICK_WALL.get(), CCBlocks.RAINBOW_BISMUTH_BRICK_WALL.get(), CCBlocks.VIOLET_BISMUTH_BRICK_WALL.get(), CCBlocks.YELLOW_BISMUTH_BRICK_WALL.get())
                .add(CCBlocks.CRUSTONE_WALL.get(), CCBlocks.CRUSTONE_BRICK_WALL.get(), CCBlocks.POLISHED_CRUSTONE_WALL.get(), CCBlocks.CRACKED_CRUSTONE_BRICK_WALL.get(), CCBlocks.CHISELED_CRUSTONE_WALL.get())
                .add(CCBlocks.HOLY_MARBLE_WALL.get(), CCBlocks.HOLY_MARBLE_BRICK_WALL.get(), CCBlocks.CHISELED_HOLY_MARBLE_WALL.get(), CCBlocks.CRACKED_HOLY_MARBLE_BRICK_WALL.get(), CCBlocks.POLISHED_HOLY_MARBLE_WALL.get())
                .add(CCBlocks.AURUM_WALL.get())
                .add(CCBlocks.PUMICE_WALL.get(), CCBlocks.PUMICE_BRICK_WALL.get(), CCBlocks.CHISELED_PUMICE_WALL.get(), CCBlocks.CRACKED_PUMICE_BRICK_WALL.get(), CCBlocks.POLISHED_PUMICE_WALL.get())
                .add(CCBlocks.PYRITE_WALL.get());

        this.tag(BlockTags.SLABS)
                .add(CCBlocks.THUNDERSTONE_SLAB.get(), CCBlocks.CHISELED_THUNDERSTONE_SLAB.get(), CCBlocks.THUNDERSTONE_BRICK_SLAB.get(), CCBlocks.POLISHED_THUNDERSTONE_SLAB.get())
                .add(CCBlocks.BISMITE_SLAB.get(), CCBlocks.CHISELED_BISMITE_SLAB.get(), CCBlocks.CRACKED_BISMITE_BRICK_SLAB.get(), CCBlocks.POLISHED_BISMITE_SLAB.get(), CCBlocks.BISMITE_BRICK_SLAB.get())
                .add(CCBlocks.CYAN_BISMUTH_SLAB.get(), CCBlocks.PURPLE_BISMUTH_SLAB.get(), CCBlocks.VIOLET_BISMUTH_SLAB.get(), CCBlocks.YELLOW_BISMUTH_SLAB.get(), CCBlocks.RAINBOW_BISMUTH_SLAB.get())
                .add(CCBlocks.CYAN_BISMUTH_BRICK_SLAB.get(), CCBlocks.PURPLE_BISMUTH_BRICK_SLAB.get(), CCBlocks.RAINBOW_BISMUTH_BRICK_SLAB.get(), CCBlocks.VIOLET_BISMUTH_BRICK_SLAB.get(), CCBlocks.YELLOW_BISMUTH_BRICK_SLAB.get())
                .add(CCBlocks.BRONCHUS_SLAB.get())
                .add(CCBlocks.CRUSTONE_SLAB.get(), CCBlocks.CRUSTONE_BRICK_SLAB.get(), CCBlocks.POLISHED_CRUSTONE_SLAB.get(), CCBlocks.CRACKED_CRUSTONE_BRICK_SLAB.get(), CCBlocks.CHISELED_CRUSTONE_SLAB.get())
                .add(CCBlocks.HOLY_MARBLE_SLAB.get(), CCBlocks.HOLY_MARBLE_BRICK_SLAB.get(), CCBlocks.CHISELED_HOLY_MARBLE_SLAB.get(), CCBlocks.CRACKED_HOLY_MARBLE_BRICK_SLAB.get(), CCBlocks.POLISHED_HOLY_MARBLE_SLAB.get())
                .add(CCBlocks.AURUM_SLAB.get(), CCBlocks.PUMICE_SLAB.get(), CCBlocks.PUMICE_BRICK_SLAB.get(), CCBlocks.CHISELED_PUMICE_SLAB.get(), CCBlocks.CRACKED_PUMICE_BRICK_SLAB.get(), CCBlocks.POLISHED_PUMICE_SLAB.get(), CCBlocks.PYRITE_SLAB.get());

        this.tag(BlockTags.STAIRS)
                .add(CCBlocks.THUNDERSTONE_STAIRS.get(), CCBlocks.CHISELED_THUNDERSTONE_STAIRS.get(), CCBlocks.THUNDERSTONE_BRICK_STAIRS.get(), CCBlocks.POLISHED_THUNDERSTONE_STAIRS.get())
                .add(CCBlocks.BISMITE_STAIRS.get(), CCBlocks.CHISELED_BISMITE_STAIRS.get(), CCBlocks.CRACKED_BISMITE_BRICK_STAIRS.get(), CCBlocks.POLISHED_BISMITE_STAIRS.get(), CCBlocks.BISMITE_BRICK_STAIRS.get())
                .add(CCBlocks.CYAN_BISMUTH_STAIRS.get(), CCBlocks.PURPLE_BISMUTH_STAIRS.get(), CCBlocks.VIOLET_BISMUTH_STAIRS.get(), CCBlocks.YELLOW_BISMUTH_STAIRS.get(), CCBlocks.RAINBOW_BISMUTH_STAIRS.get())
                .add(CCBlocks.CYAN_BISMUTH_BRICK_STAIRS.get(), CCBlocks.PURPLE_BISMUTH_BRICK_STAIRS.get(), CCBlocks.RAINBOW_BISMUTH_BRICK_STAIRS.get(), CCBlocks.VIOLET_BISMUTH_BRICK_STAIRS.get(), CCBlocks.YELLOW_BISMUTH_BRICK_STAIRS.get())
                .add(CCBlocks.BRONCHUS_STAIRS.get())
                .add(CCBlocks.CRUSTONE_STAIRS.get(), CCBlocks.CRUSTONE_BRICK_STAIRS.get(), CCBlocks.POLISHED_CRUSTONE_STAIRS.get(), CCBlocks.CRACKED_CRUSTONE_BRICK_STAIRS.get(), CCBlocks.CHISELED_CRUSTONE_STAIRS.get())
                .add(CCBlocks.HOLY_MARBLE_STAIRS.get(), CCBlocks.HOLY_MARBLE_BRICK_STAIRS.get(), CCBlocks.CHISELED_HOLY_MARBLE_STAIRS.get(), CCBlocks.CRACKED_HOLY_MARBLE_BRICK_STAIRS.get(), CCBlocks.POLISHED_HOLY_MARBLE_STAIRS.get())
                .add(CCBlocks.AURUM_STAIRS.get(), CCBlocks.PUMICE_STAIRS.get(), CCBlocks.PUMICE_BRICK_STAIRS.get(), CCBlocks.CHISELED_PUMICE_STAIRS.get(), CCBlocks.CRACKED_PUMICE_BRICK_STAIRS.get(), CCBlocks.POLISHED_PUMICE_STAIRS.get(), CCBlocks.PYRITE_STAIRS.get());
