...
public class CCBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(CCBlocks.CYAN_BISMUTH_BRICKS_STAIRS.get(), CCBlocks.CYAN_BISMUTH_BRICKS_SLAB.get(), CCBlocks.CYAN_BISMUTH_BRICKS_WALL.get())
        ...
        this.tag(BlockTags.WALLS)
                ...
                .add(CCBlocks.CYAN_BISMUTH_BRICKS_WALL.get(), CCBlocks.PURPLE_BISMUTH_BRICKS_WALL.get(), CCBlocks.RAINBOW_BISMUTH_BRICKS_WALL.get(), CCBlocks.VIOLET_BISMUTH_BRICKS_WALL.get(), CCBlocks.YELLOW_BISMUTH_BRICKS_WALL.get())
        ...
        this.tag(BlockTags.SLABS)
                ...
                .add(CCBlocks.CYAN_BISMUTH_BRICKS_SLAB.get(), CCBlocks.PURPLE_BISMUTH_BRICKS_SLAB.get(), CCBlocks.RAINBOW_BISMUTH_BRICKS_SLAB.get(), CCBlocks.VIOLET_BISMUTH_BRICKS_SLAB.get(), CCBlocks.YELLOW_BISMUTH_BRICKS_SLAB.get())
                .add(CCBlocks.BRONCHUS_SLAB.get())
        ...
        this.tag(BlockTags.STAIRS)
                ...
                .add(CCBlocks.CYAN_BISMUTH_BRICKS_STAIRS.get(), CCBlocks.PURPLE_BISMUTH_BRICKS_STAIRS.get(), CCBlocks.RAINBOW_BISMUTH_BRICKS_STAIRS.get(), CCBlocks.VIOLET_BISMUTH_BRICKS_STAIRS.get(), CCBlocks.YELLOW_BISMUTH_BRICKS_STAIRS.get())
                .add(CCBlocks.BRONCHUS_STAIRS.get())
