...
public class LargeMuscleDripstoneConfiguration implements FeatureConfiguration {
    public static final Codec<LargeMuscleDripstoneConfiguration> CODEC = RecordCodecBuilder.create(
            p_160966_ -> p_160966_.group(
                    ...
                    .apply(p_160966_, LargeMuscleDripstoneConfiguration::new)
    );
    ...
    public LargeMuscleDripstoneConfiguration(
            int p_160956_,
