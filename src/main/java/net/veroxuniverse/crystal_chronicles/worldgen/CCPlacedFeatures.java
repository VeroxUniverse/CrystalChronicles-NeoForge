...
public class CCPlacedFeatures {
    public static final ResourceKey<PlacedFeature> MUSCLE_DRIPSTONE_PLACED_KEY = registerKey("muscle_dripstone_placed");

    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        HolderGetter<ConfiguredFeature<?, ?>> configuredFeatures = context.lookup(Registries.CONFIGURED_FEATURE);

        register(context, MUSCLE_DRIPSTONE_PLACED_KEY, configuredFeatures.getOrThrow(CCConfiguredFeatures.MUSCLE_DRIPSTONE_KEY),
